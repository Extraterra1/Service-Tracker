    ...
    <main className="landing-page" aria-labelledby="landing-title">
      ...
      <section className="landing-card">
        <div className="landing-logo-wrap">
          <img className="landing-logo" src={justDriveLogo} alt="JustDrive Madeira Rent-A-Car" />
        </div>

        <div className="landing-content">
          <p className="landing-eyebrow">Operação Interna</p>
          <h1 id="landing-title" className="landing-title">
            Service Tracker
          </h1>
          <p className="landing-copy">Inicia sessão com a tua conta de equipa para acederes a entregas, recolhas e atualizações em tempo real.</p>
        </div>
