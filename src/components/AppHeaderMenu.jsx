        ...
        <details ref={menuPanelRef} className="menu-panel">
          ...
          <div className="menu-content">
            ...
            <div className="menu-sections">
              ...
              <details
                className={`menu-section menu-section-group ${closingSections[MENU_SECTION_KEYS.accountGroup] ? 'is-closing' : ''}`}
                open={openSections[MENU_SECTION_KEYS.accountGroup] || closingSections[MENU_SECTION_KEYS.accountGroup]}
              >
                <summary className="menu-section-summary" onClick={handleSectionSummaryClick(MENU_SECTION_KEYS.accountGroup)}>
                  Conta
                </summary>
                <div className="menu-section-body menu-group-body">
                  <details
              ...
              <details
                className={`menu-section menu-section-group ${closingSections[MENU_SECTION_KEYS.serviceManagement] ? 'is-closing' : ''}`}
                open={openSections[MENU_SECTION_KEYS.serviceManagement] || closingSections[MENU_SECTION_KEYS.serviceManagement]}
              >
                <summary className="menu-section-summary" onClick={handleSectionSummaryClick(MENU_SECTION_KEYS.serviceManagement)}>
                  Gerir Serviço
                </summary>
                <div className="menu-section-body menu-group-body">
                  <details
